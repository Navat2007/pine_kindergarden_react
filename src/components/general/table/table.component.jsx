...
const Table = ({
    ...
    React.useEffect(() => {
        //console.log("table_" + title, Cookies.get("table_" + title));
            ...
            case "image":
                return value ? (
                    <img
                        ...
                        src={window.global.baseUrl + value}
                        alt={""}
                    />
                ) : (
                    <></>
            ...
            case "string":
                if (configItem.key === "status") {
                    switch (value) {
                        case "Новая":
                            return (
                                <p className="request-status --place-table --status-new">
                                    Новая
                                </p>
                            );
                        case "Принята":
                            return (
                                <p className="request-status --place-table --status-accept">
                                    Принята
                                </p>
                            );
                        case "Отклонена":
                        case "Удаление отклонено":
                            return (
                                <p className="request-status --place-table --status-decline">
                                    Отклонена
                                </p>
                            );
                        case "Отозвана":
                            return (
                                <p className="request-status --place-table --status-callback">
                                    Отозвана
                                </p>
                            );
                        case "Рассмотрение":
                            return (
                                <p className="request-status --place-table --status-review">
                                    Рассмотрение
                                </p>
                            );
                        case "Удаление":
                            return (
                                <p className="request-status --status-decline">Удаление</p>
                            );
                        default:
                            return <>{value}</>;
                    }
            ...
            for (const item of items) {
                ...
                for (let prop in filter)
                    tmpFilter[prop] = !!(
                        ...
                        checkItem(
                            itemsConfig.find(
                                (itemConfig) => itemConfig.key === prop
                            ),
                            item,
                            filter,
                            prop
